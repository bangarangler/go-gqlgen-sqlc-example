...
//go:generate go run github.com/vektah/dataloaden AgentLoader int64 *github.com/bangarangler/go-gqlgen-sqlc-example/pg.Agent
//go:generate go run github.com/vektah/dataloaden AuthorSliceLoader int64 []github.com/bangarangler/go-gqlgqlgen-sqlc-example/pg.Author
//go:generate go run github.com/vektah/dataloaden BookSliceLoader int64 []github.com/bangarangler/go-gqlgen-sqlc-example/pg.Book

// one small issue. when i generate for AuthorSliceLoader if messes up the
// import and just has it ass all Author -> must be changed to pg.Author
// everywhere and then it works fine. weird.
